...
<div id="main_content" class="content">
    <div class="box_very_large">
    	<h2>
	        Brief summary last Christmas (2023):
		     <ul>
			     <li>Prepared gifts: 45</li>
			     <li>Gifts taken: 7</li>
			     <li>Gifts vandalized: 5</li>
			     <li>Not delivered: 1</li>
			     <li>Delivered: 1</li>
			     <li>Gifts received: 1</li>
			     <li>Gifts stolen: 2 (received + delivered)</li>
		     </ul>
	 	</h2>
    </div>
</div>
