...
$api_call1 = array(
	...
	"url" => "/api/v1.1/get_available_languages.php",
	"method" => "GET",
...
$api_call2 = array(
	...
	"url" => "/api/v1.1/get_available_element_ranges.php",
	"method" => "GET",
...
$api_call3 = array(
	...
	"url" => "/api/v1.1/get_philosophy_content.php",
	"method" => "GET",
...
$api_call4 = array(
	...
	"url" => "/api/v1.1/search_keys_by_words.php",
	"method" => "GET",
...
$api_call_specification_list = array($api_call1,$api_call2,$api_call3,$api_call4);
